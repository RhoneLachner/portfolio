  ...
  return (
    <>
      <span className="rhoneIs">
        Hello! My name is Rhone, and I am a Full Stack Software Engineer <br />{" "}
        based in Portland, OR.
      </span>
      <div className="bioDiv">
        <FadeInAnimation wrapperElement="p" className="bioText">
          Hello! My name is Rhone and I am a Full-Stack Software Engineer,
          Associate Product Manager, and Musician based in Vancouver, WA. <br />
          <br />
          ...
          to all that I do. <br />
          <br />
          In 2023: I will be shifting more of my professional focus into
          Technical Product Management with the intention of incorporating
          several of my skillsets into a single holistic setting. <br />
          <br />
          ...
          exploration, and preparing to record a new album with my band.
          <br />
          <br />
